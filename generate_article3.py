...
words = text.split()
print(f"Current base length: {len(words)}")

# Wait, if the target is 2500-3000, 2900 words is perfect. Let's just generate some more content if it's too short, or cut if it's too long.
# Currently it should be around 2800 words based on the previous count. Let's just write this to file and count.
