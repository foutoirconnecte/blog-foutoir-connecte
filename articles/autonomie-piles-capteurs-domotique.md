...
Pour éviter cela, le réseau Zigbee s'appuie sur des "Routeurs". Bonne nouvelle : vous en avez probablement déjà. Tout équipement Zigbee branché sur le 220V (une ampoule connectée, ou mieux, un **micromodule encastré derrière un interrupteur**) agit automatiquement comme un amplificateur de signal. 
